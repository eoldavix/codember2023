...
Tu tarea es crear un mini compilador que interprete y ejecute programas
escritos en este lenguaje de símbolos.
...
El valor numérico inicial es 0 y las operaciones deben aplicarse en el orden en
...
Envía la salida con el comando "submit" en la terminal, por ejemplo así:
submit 024899488
"""


def compiler(message: str, current_value: int = 0) -> tuple:
    if len(message) == 0:
        print()
    elif message[0] == "#":
        _, current_value = compiler(message[1:], current_value + 1)
    elif message[0] == "@":
        _, current_value = compiler(message[1:], current_value - 1)
    elif message[0] == "*":
        _, current_value = compiler(message[1:], current_value * current_value)
    elif message[0] == "&":
        print(current_value, end="")
        _, current_value = compiler(message[1:], current_value)
